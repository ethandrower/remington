...
"""
    ...
    # ── PM Approval workflow stubs ─────────────────────────────────────────────
    # These are no-ops in the simple orchestrator (Claude Code not available).
    # Full implementation lives in ClaudeCodeOrchestrator.

    def parse_approval_response(self, message_text: str) -> Dict:
        """Stub — approval parsing requires Claude Code orchestrator."""
        return {"is_approval_response": False}

    def handle_pm_approval(self, request_id: str) -> Dict:
        """Stub — approval handling requires Claude Code orchestrator."""
        return {"status": "skipped", "reason": "Simple orchestrator — Claude Code not available"}

    def handle_pm_revision(self, request_id: str, feedback: str) -> Dict:
        """Stub — revision handling requires Claude Code orchestrator."""
        return {"status": "skipped", "reason": "Simple orchestrator — Claude Code not available"}

    def handle_pm_cancellation(self, request_id: str) -> Dict:
        """Stub — cancellation handling requires Claude Code orchestrator."""
        return {"status": "skipped", "reason": "Simple orchestrator — Claude Code not available"}

    def process_pr_review(self, **kwargs) -> Dict:
        """Stub — PR review requires Claude Code orchestrator."""
        return {"status": "skipped", "reason": "Simple orchestrator — Claude Code not available"}
