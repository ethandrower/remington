...
class JiraAPIClient:
    ...
    def __init__(self):
        ...
        # Derive domain from JIRA_INSTANCE_URL (e.g. "https://company.atlassian.net" → "company.atlassian.net")
        jira_url = os.getenv("JIRA_INSTANCE_URL", "")
        self.domain = os.getenv("ATLASSIAN_DOMAIN") or jira_url.replace("https://", "").replace("http://", "").rstrip("/")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("  JIRA_INSTANCE_URL=https://your-company.atlassian.net\n")
