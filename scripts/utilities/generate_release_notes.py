...
RELEASE_NOTES_SPACE = os.getenv("ATLASSIAN_PROJECT_KEY", "")
ENGINEERING_SPACE = os.getenv("CONFLUENCE_ENGINEERING_SPACE", "")
ENGINEERING_RELEASE_OPS_PARENT_ID = os.getenv("CONFLUENCE_ENGINEERING_PARENT_ID", "")
...
def generate_feature_writeup(issue: Dict) -> str:
    ...
    writeup = f"""
<h3>{summary}</h3>
<p><strong>Reference:</strong> <a href="{JIRA_WEB_URL}/browse/{key}">{key}</a></p>
<p>{intro} {benefit}.</p>
"""
...
<td><a href="{JIRA_WEB_URL}/browse/{key}">{key}</a></td>
</tr>"""
