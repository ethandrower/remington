"""
Fetch PR #245 details, diff, and diffstat from Bitbucket.
...
def main():
    ...
    details_path = os.path.join(PROJECT_ROOT, "pr245_details.json")
    ...
    diff_path = os.path.join(PROJECT_ROOT, "pr245_full_diff.txt")
    ...
    diffstat_path = os.path.join(PROJECT_ROOT, "pr245_diffstat.json")
